#!/usr/bin/env python3
"""ClimbMix retrieval helper (v2: query-match-centered previews).

Self-contained (stdlib). Reads PYSERINI_API_TOKEN from env or repo .env.local.
...
_ENV_FALLBACKS = (".env.local", "/Users/lingweigu/Research/agent-plus/.env.local")
_STOP = set(
