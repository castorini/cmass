...
// build_scrutiny_inputs.py). The released script embeds no question text.
const INPUTS = "inputs";  // per-question {question, answer, hops} files from build_scrutiny_inputs.py
